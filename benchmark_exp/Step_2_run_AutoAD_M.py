...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_list', type=str, default='/data/liuqinghua/code/ts/TSAD-AutoML/TSB-AutoAD/testbed/file_list/TSB-AD-M-Eval.csv')
    parser.add_argument('--score_dir', type=str, default='/data/liuqinghua/code/ts/TSAD-AutoML/TSB-AutoAD/resource/score/multi/')
    parser.add_argument('--score_unif_dir', type=str, default='/data/liuqinghua/code/ts/TSAD-AutoML/TSB-AutoAD/resource/score_unif/multi')
    parser.add_argument('--pretrained_weights', type=str, default='/data/liuqinghua/code/ts/TSAD-AutoML/TSB-AutoAD/TSB_AutoAD/Meta_learning/Pretraining_pipeline/weights/TSB-AD-M/')
    parser.add_argument('--eval_path', type=str, default='/data/liuqinghua/code/ts/TSAD-AutoML/TSB-AutoAD/benchmark_exp/eval/Candidate/TSB-AD-M/')
    parser.add_argument('--eval_list', type=str, default='/data/liuqinghua/code/ts/TSAD-AutoML/TSB-AutoAD/testbed/file_list/TSB-AD-M-Label.csv')

    parser.add_argument('--AutoAD_Name', type=str, default='Synthetic')
    parser.add_argument('--variant', type=str, default='Orig-speedup')
    
    parser.add_argument('--save', type=bool, default=False)
    parser.add_argument('--resume', type=bool, default=False)
    parser.add_argument('--save_dir', type=str, default='/data/liuqinghua/code/ts/TSAD-AutoML/TSB-AutoAD/benchmark_exp/eval/AutoAD/TSB-AD-M/')
