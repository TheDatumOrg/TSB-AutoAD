...
setup(
    name='TSB_AutoAD',  # Replace with your own package name
    version='0.1',  # The version of your package
    author='The Datum Lab',  # Your name
    description='Automated Solutions for Time-Series Anomaly Detection',  # A short description
    ...
    url='https://github.com/TheDatumOrg/TSB-AutoAD',  # Link to the repository or website
